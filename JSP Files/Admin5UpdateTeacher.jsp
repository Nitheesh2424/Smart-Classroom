...
<body>
    <form method="POST" action ="cb">
        <input name="name" placeholder="User Name" class="name" required /><br>
        <input name="emailid" placeholder="EMAIL ID" class="email" type="email" required /><br>
          <input name="mobnum" placeholder="MOBILE NUMBER" class="email" type="text" required /><br>
            <input name="op" type="password" placeholder="OLD PASSWORD" class="email" type="email" required /><br>
            <input name="np" type="password" placeholder="NEW PASSWORD" class="email" type="email" required /><br><br>
            <input name="submit" class="btn" type="submit" value="RESET PASSWORD" />
        </form>
</body>
</html>