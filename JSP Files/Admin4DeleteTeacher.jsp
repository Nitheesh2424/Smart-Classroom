...
<body>
    <form method="POST" action ="cottonc">
        <input name="id" placeholder="ENTER TEACHER ID" class="name" required /><br><br>
        
            <input name="submit" class="btn" type="submit" value="DELETE ID" />
        </form>
</body>
</html>